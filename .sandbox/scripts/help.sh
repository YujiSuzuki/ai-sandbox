...
show_script_list() {
    ...
    local container_only="sync-secrets.sh validate-secrets.py sync-compose-secrets.sh check-undeclared-secrets.py check-secret-sync.py compare-secret-config.py triage-undeclared-secrets.py"

...
def get_messages(lang_ja: bool) -> dict:
    if lang_ja:
        return {
            ...
            "CLAUDE_ONLY_NOTE": "（.claude/settings.json では既にカバー済み。sync-secrets.sh で対処できます）",
            "FILE_TYPE": "File",
            "DIR_TYPE": "Dir",
    ...
    return {
        ...
        "CLAUDE_ONLY_NOTE": "(already covered by .claude/settings.json -- can also be handled by sync-secrets.sh)",
        "FILE_TYPE": "File",
        "DIR_TYPE": "Dir",

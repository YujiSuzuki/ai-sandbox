...
The code-review plugin normally requires the gh (GitHub CLI) command. Here, we'll configure it to work locally without gh dependency. (Adjust to your preferences.)
   ...
   > **Ready-to-use commands**: Commands built on the above requirements are already provided. See [.sandbox/commands/README.md](../.sandbox/commands/README.md) for installation instructions and the full command list.

...
DockMCP の機能を具体的な例で体験するには、[ai-sandbox-demo](https://github.com/YujiSuzuki/ai-sandbox-demo) の SecureNote デモを使います：
...
1. DockMCP サーバーが起動中か確認: `curl http://localhost:18080/health`

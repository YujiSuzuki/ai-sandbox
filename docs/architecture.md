...
| Environment | Scripts |
|---|---|
| `container` (container only) | `sync-secrets.py`, `validate-secrets.py`, `sync-compose-secrets.py`, `check-secret-sync.py`, `compare-secret-config.py`, `check-undeclared-secrets.py`, `triage-undeclared-secrets.py` |

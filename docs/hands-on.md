...
> [!IMPORTANT]
> These exercises use the SecureNote demo app. Clone [ai-sandbox-demo](https://github.com/YujiSuzuki/ai-sandbox-demo) and place it alongside your workspace before starting:
> ```bash
